      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-2">
          ...
          <h1 className="text-5xl md:text-6xl font-black uppercase italic tracking-tighter text-foreground">
            Danh mục <span className="text-interaction">Nguyên liệu</span>
          </h1>
          <p className="text-foreground/40 font-bold italic">Quản lý nguyên liệu thô và giá vốn đầu vào.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {loading && ingredients.length === 0 ? (
          ...
          <div className="col-span-full ai-card py-32 text-center flex flex-col items-center gap-6 opacity-20">
            ...
            <p className="text-xl font-black uppercase italic tracking-tighter">Chưa có nguyên liệu nào</p>
          </div>
        ) : (
          filteredIngredients.map((item) => (
            ...
            >
              ...
              <div className="mt-8 pt-6 border-t border-foreground/5 flex items-end justify-between">
                <div>
                  <p className="text-[10px] font-black text-foreground/20 uppercase tracking-widest mb-1 italic">Giá vốn ước tính</p>
