...
export default function StoreSettings({ storeInfo, updateStore }: StoreSettingsProps) {
  const t = useTranslations('Dashboard.settings.storeTab');
    ...
    <div className="ai-card p-12 space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-3">
          <label className="text-[10px] font-black text-foreground/40 uppercase ml-1 tracking-widest italic">{t('storeName')}</label>
          <input 
            type="text" 
            value={formData.name}
        ...
        <div className="space-y-3">
          <label className="text-[10px] font-black text-foreground/40 uppercase ml-1 tracking-widest italic">{t('phone')}</label>
          <input 
            type="text" 
        ...
        <div className="md:col-span-2 space-y-3">
          <label className="text-[10px] font-black text-foreground/40 uppercase ml-1 tracking-widest italic">{t('address')}</label>
          <input 
            type="text" 
